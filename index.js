...
const manifest = {
  ...
  version: '1.2.143', // Incrementada por depuración de /generate-url
...
router.post('/generate-url', (req, res) => {
  ...
  try {
    ...
    // Usar dominio fijo para evitar problemas con req.get('host')
        ...
        <head>
          ...
          <script>
            function copyManifest() {
              navigator.clipboard.writeText(${JSON.stringify(manifestJson)}).then(() => {
