...
async function generatePosterWithHour({ partido, hora, deporte, competicion, dia }) {
  ...
  if (!posterSourceUrl?.startsWith('http')) {
    ...
    } else if (isRugby && competicion?.toLowerCase() === 'premiership') {
      posterSourceUrl = 'https://res.cloudinary.com/doimszxld/image/upload/plantillas/Rugby_Premiership.jpeg';
    } else if (
    ...
    (deporte && deporte.toLowerCase() === 'mlb') ||
