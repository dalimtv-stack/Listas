      ...
      (error, result) => {
        if (error) {
          ...
          const formats = {
            ...
            border20_black: `https://res.cloudinary.com/${cloudName}/image/upload/ar_0.675,b_black,c_pad,w_405,f_auto/bo_20px_solid_black/${cleanPublicId}`,
            border20_white: `https://res.cloudinary.com/${cloudName}/image/upload/ar_0.675,b_white,c_pad,w_405,f_auto/bo_20px_solid_white/${cleanPublicId}`,
